...
public class C05_IfElse {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Lütfen üc karakterden daha uzun bir kelime giriniz");
        String kelime = scan.next();

        int uzuluk = kelime.length();

        if (uzuluk <= 3) {
            System.out.println("3Karaterden daha uzun bir kelime girmelisiniz");
        } else {
            String sonUc = kelime.substring(uzuluk - 3);
